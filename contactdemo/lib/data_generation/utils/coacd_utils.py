...
def convex_decompose_coacd(input_file, output_file, args=None):
    if args is None:
        args = argparse.Namespace()
        args.threshold = 0.05
        args.max_convex_hull = -1
        args.preprocess_mode = "auto"
        args.prep_resolution = 50
        args.resolution = 2000
        args.mcts_node = 20
        args.mcts_iteration = 150
        args.mcts_max_depth = 3
        args.pca = False
        args.no_merge = False
        args.seed = 0
...
if __name__ == "__main__":
    ...
    convex_decompose_coacd(input_file, output_file, args)
